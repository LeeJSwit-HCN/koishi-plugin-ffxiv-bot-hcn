...
exports.name = 'ffxiv-bot';
exports.schema = koishi_1.Schema.intersect([
    koishi_1.Schema.object({
        Data_Center: koishi_1.Schema.union([
            'China',
            'Japan',
            'North-America',
            'Europe',
    ...
    koishi_1.Schema.union([
        koishi_1.Schema.object({
            Data_Center: koishi_1.Schema.const('China').required(),
            Server: koishi_1.Schema.union(['点此项切换数据中心(bug)', '陆行鸟', '莫古力', '猫小胖', '豆豆柴']).description('服区').required(),
        }),
        koishi_1.Schema.object({
            Data_Center: koishi_1.Schema.const('Japan').required(),
            Server: koishi_1.Schema.union(['点此项切换数据中心(bug)', 'Elemental', 'Gaia', 'Mana', 'Meteor']).description('服区').required(),
        }),
        koishi_1.Schema.object({
            Data_Center: koishi_1.Schema.const('North-America').required(),
            Server: koishi_1.Schema.union(['点此项切换数据中心(bug)', 'Aether', 'Primal', 'Crystal', 'Dynamis']).description('服区').required(),
        }),
        koishi_1.Schema.object({
            Data_Center: koishi_1.Schema.const('Europe').required(),
            Server: koishi_1.Schema.union(['点此项切换数据中心(bug)', 'Chaos', 'Light']).description('服区').required()
        }),
        koishi_1.Schema.object({
            Data_Center: koishi_1.Schema.const('Oceania').required(),
            Server: koishi_1.Schema.union(['点此项切换数据中心(bug)', 'Materia']).description('服区').required(),
        }),
    ]),
    koishi_1.Schema.object({
